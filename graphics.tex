...
\gdef\ESKDtheTitle{Схема взаимодействия пользователя с системой}
\begin{center}
  \vspace*{10mm}
...
\gdef\ESKDtheTitle{Диаграмма развертывания}
\begin{center}
  \vspace*{10mm}
...
\gdef\ESKDtheTitle{Схема электрическая принципиальная}
\begin{center}
  \vspace*{10mm}
